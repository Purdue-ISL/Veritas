...
from src.veritas.frameworks import FrameworkFitHMMStream
...
# Register customized throughput estimation function tightly below this comment.
...
def main() -> None:
    ...
    """
    #
    framework = FrameworkFitHMMStream(disk=os.path.join("logs", "fit"), clean=False, strict=False)
    framework([])
