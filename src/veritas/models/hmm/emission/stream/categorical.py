...
class ModelEmissionStreamCategoricalPseudo(ModelEmission[Inputs, Outputs]):
    R"""
    Pseudo video streaming categorical emission distribution model.
    This can force a convention HMM to be a video streaming like HMM.
    """

    def __init__(
        self: ModelEmissionStreamCategoricalPseudo,
        model: ModelEmissionCategorical,
        /,
    ) -> None:
        R"""
    ...
    def forward(self: ModelEmissionStreamCategoricalPseudo, inputs: Memory, /) -> Memory:
        R"""
        Forward.
    ...
    @classmethod
    def inputs(cls: Type[ModelEmissionStreamCategoricalPseudo], memory: Memory, /) -> Inputs:
        R"""
        ...
        """
        #
        return ModelEmissionCategorical.inputs(memory)

    @classmethod
    def outputs(cls: Type[ModelEmissionStreamCategoricalPseudo], memory: Memory, /) -> Outputs:
        R"""
        ...
        #
        (gaps, *memory) = memory
        return (gaps, *ModelEmissionCategorical.outputs(memory))

    def estimate(self: ModelEmissionStreamCategoricalPseudo, /) -> None:
        R"""
    ...
    def accumulate(self: ModelEmissionStreamCategoricalPseudo, inputs: Memory, posterior: THNUMS, /) -> None:
        R"""
    ...
    def maximize(self: ModelEmissionStreamCategoricalPseudo, /) -> None:
        R"""
    ...
    def backward(self: ModelEmissionStreamCategoricalPseudo, /) -> None:
        R"""
